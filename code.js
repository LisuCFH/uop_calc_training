...
class MonthlyEmployeeIncome {
    ...
    // Dochód, który jest wynikiem pomniejszenia o koszty uzyskania przychodu 250 zł
    income;
    ...
    calculate(grossAmount, monthNum, accumulatedYearlyIncomeSum) {
        ...
        // Suma składek na ubezpieczenie społeczne
        // finansowane przez pracownika:
        this.workerSocialContributionsSum = this.retirementContribution 
        + this.pensionContribution + this.sicknessContribution;
        console.log("Suma składek na ubezpieczenie społeczne finansowane przez pracownika: ", this.workerSocialContributionsSum);

        // Podstawa wymiaru składki na ubezpieczenie zdrowotne:
        this.baseForHealthContribution = grossAmount - this.workerSocialContributionsSum;
        ...
        // Kwota netto:
        this.finalWorkerNetMoney = grossAmount - this.workerSocialContributionsSum
